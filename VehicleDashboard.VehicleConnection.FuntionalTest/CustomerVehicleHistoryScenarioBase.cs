...
namespace VehicleDashboard.VehicleConnection.FuntionalTest
{
    public class CustomerVehicleHistoryScenarioBase
    {
        //public TestServer CreateServer()
        //{
        //    var path = Assembly.GetAssembly(typeof(CustomerVehicleHistoryScenarioBase))
        //      .Location;
