...
using VehicleDashboard.EventBus.Extensions;

namespace VehicleDashboard.EventBusRabbitMQ
{
    public class EventBusRabbitMQ : IEventBus, IDisposable
    {
        ...
        private readonly string AUTOFAC_SCOPE_NAME = "vehicleDashboard_event_bus";
